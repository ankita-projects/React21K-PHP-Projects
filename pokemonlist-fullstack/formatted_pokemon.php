<?php
    ...
    $formatted_data['next'] =  'http://localhost/React21K-PHP-Projects/pokemonlist-fullstack/formatted_pokemon.php?page=1';      //setting the next and previous url in json response
    if($page>1){
